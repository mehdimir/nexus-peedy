    ...
    extends AbstractLocalRepositoryStorage
{
        ...
        throws ItemNotFoundException, StorageException
    {
        ...
        if ( target.exists() && target.isDirectory() )
        {
            ...
            DefaultStorageCollectionItem coll = new DefaultStorageCollectionItem( repository, request );
        ...
        else if ( target.exists() && target.isFile() && !mustBeACollection )
        {
            ...
            if ( checkBeginOfFile( LINK_PREFIX, target ) )
            {
                try
                {
                    DefaultStorageLinkItem link =
                        new DefaultStorageLinkItem( repository, request, getLinkTarget( target ) );
            ...
            else
            {
                DefaultStorageFileItem file =
                    new DefaultStorageFileItem( repository, request, new FileContentLocator( target, getMimeUtil()
                        .getMimeType( target ) ) );
