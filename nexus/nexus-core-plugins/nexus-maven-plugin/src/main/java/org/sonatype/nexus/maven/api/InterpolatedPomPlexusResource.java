package org.sonatype.nexus.maven.api;
...
import org.sonatype.nexus.maven.MavenGate;
        ...
        throws ResourceException
    {
        try
        {
            ProjectBuildingResult result =
                mavenGate
                    .buildMavenProject( getPom( request ), Collections.singletonList( "public" ), null, null, null );

            result.getProject().getModel();
