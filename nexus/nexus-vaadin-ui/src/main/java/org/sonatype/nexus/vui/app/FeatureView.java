...
import org.sonatype.nexus.vui.app.ActiveLink.LinkActivatedListener;
    ...
    public FeatureView( NexusVuiApplication nva )
    {
        ...
        showSrc.addListener( new LinkActivatedListener()
        {
            ...
            public void linkActivated( LinkActivatedEvent event )
            {
                ...
                {
                    showSource( currentFeature.getExampleSource() );
                }
    ...
    public void setFeature( Feature feature )
    {
        if ( feature != currentFeature )
        {
            ...
            { // open src in new window -link
                String path = nexusVuiApplication.getPathFor( currentFeature );
            ...
            if ( features != null )
            {
                ...
                for ( Class<? extends Feature> c : features )
                {
                    ...
                    if ( f != null )
                    {
                        ...
                        ActiveLink al =
                            new ActiveLink( f.getName(), new ExternalResource( getApplication().getURL() + "#" + path ) );
